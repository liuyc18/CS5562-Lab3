"""
Modified from https://github.com/cybertronai/autograd-hacks
...
_supported_layers = ['Linear', 'Conv2d', 'Parameter']  # Supported layer class types
...
def compute_grad1(model: nn.Module, loss_type: str = 'mean') -> None:
    ...
    for name, layer in model.named_modules():
        #! Only compute indiv grads for last layer
        if name != "classifier":
            continue
